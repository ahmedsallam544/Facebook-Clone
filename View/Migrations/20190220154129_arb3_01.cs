...
{
    public partial class arb3_01 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserFriends", x => new { x.FriendUserID, x.OwnerUserID });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserFriends_AspNetUsers_OwnerUserID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserFriends_OwnerUserID",
                table: "UserFriends",
                column: "OwnerUserID");
        }
